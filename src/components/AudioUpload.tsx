...
import { Upload, FileAudio, CheckCircle, Loader } from "lucide-react";
import { useToast } from "@/hooks/use-toast";

type UploadState = 'idle' | 'uploading' | 'uploaded' | 'transcribing' | 'completed';
          ...
          setTimeout(() => {
            ...
            setTimeout(() => {
              ...
              toast({
                ...
                description: "Your podcast has been processed and content generated.",
              });
            }, 3000);
          }, 1000);
        ...
        <Card className="bg-white/10 backdrop-blur-lg border-white/20">
          ...
          <CardContent className="p-8">
            ...
            {uploadState === 'completed' && (
              <div className="text-center">
                <CheckCircle className="w-16 h-16 text-green-400 mx-auto mb-6" />
                <h3 className="text-xl text-white mb-4">Content Generated Successfully!</h3>
                <p className="text-white/60 mb-6">
                  Your podcast has been processed and content is ready
                </p>
